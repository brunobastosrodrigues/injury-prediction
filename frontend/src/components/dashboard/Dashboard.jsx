    ...
    <div className="space-y-6">
      ...
      {runningJobs.length > 0 && (
        <div className="p-4 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-white font-medium">{runningJobs.length} job{runningJobs.length > 1 ? 's' : ''} running</span>
          </div>
        </div>
      )}
      ...
      <div className="min-h-[400px]">
        ...
        {activeTab === 'introduction' && (
          <div className="space-y-6">
            {/* Research Question */}
            <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-900/20 via-slate-900 to-purple-900/20 border border-blue-500/20">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white mb-2">Research Question</h2>
            ...
            <Card title="Why Triathletes?">
              <div className="space-y-4 text-sm text-slate-400">
                <p>
                  <strong className="text-slate-300">High injury prevalence:</strong> Training-related injuries affect 37-56% of triathletes annually,
                ...
                <p>
                  <strong className="text-slate-300">Wearable adoption:</strong> Triathletes are early adopters of wearable technology (Garmin, Whoop, Oura),
                ...
                <p>
                  <strong className="text-slate-300">Periodization complexity:</strong> Triathlon training follows structured periodization (base, build, peak, taper)
            ...
            <Card title="Why Multimodal Data Matters">
              <div className="space-y-4 text-sm text-slate-400">
                <p>
                  <strong className="text-slate-300">Beyond training load:</strong> Most injury prediction studies focus solely on training load
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                  <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                    <h4 className="font-semibold text-slate-300 mb-2">Training Load Features</h4>
                  ...
                  <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                    <h4 className="font-semibold text-slate-300 mb-2">Recovery Features</h4>
                    <ul className="text-xs space-y-1 text-slate-500">
              ...
              <div className="space-y-4 text-sm text-slate-400">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-300">Synthetic Data Framework</h4>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-300">Causal Mechanism Verification</h4>
                      <p className="text-xs text-slate-500 mt-1">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-300">Full Reproducibility</h4>
                      <p className="text-xs text-slate-500 mt-1">
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b border-slate-700">
                      <th className="text-left py-2 px-3 text-slate-400 font-medium">Study</th>
                      <th className="text-left py-2 px-3 text-slate-400 font-medium">Population</th>
                      <th className="text-left py-2 px-3 text-slate-400 font-medium">Features</th>
                      <th className="text-left py-2 px-3 text-slate-400 font-medium">Limitation</th>
                    </tr>
                  </thead>
                  <tbody className="text-slate-500">
                    ...
                    <tr className="border-b border-slate-800">
                      ...
                      <td className="py-2 px-3 text-slate-300">Triathletes</td>
                      <td className="py-2 px-3 text-slate-300">Load + Recovery</td>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-slate-400">
                This platform provides two ways to engage with our research: <strong className="text-slate-300">explore the published study</strong> with
                pre-loaded results, or <strong className="text-slate-300">run your own experiments</strong> with custom configurations.
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Explore Published Study */}
              <div className="p-6 rounded-2xl bg-gradient-to-br from-green-900/20 via-slate-900 to-emerald-900/20 border border-green-500/20">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white">Explore the Published Study</h3>
                    <p className="text-xs text-slate-500">Pre-loaded results from our paper</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <Link to="/validation" className="flex items-center gap-3 p-3 rounded-lg bg-slate-800/50 hover:bg-slate-800 transition-colors">
                    <span className="text-green-400">🔬</span>
                    <div className="flex-1">
                      <p className="text-sm text-slate-300">Data Validation Results</p>
                      <p className="text-xs text-slate-500">Three Pillars, Sim2Real transfer, causal verification</p>
                    </div>
                  </Link>
                  <Link to="/results" className="flex items-center gap-3 p-3 rounded-lg bg-slate-800/50 hover:bg-slate-800 transition-colors">
                    <span className="text-green-400">📈</span>
                    <div className="flex-1">
                      <p className="text-sm text-slate-300">Model Performance</p>
                      <p className="text-xs text-slate-500">ROC curves, PR curves, calibration plots</p>
                    </div>
                  </Link>
                  <Link to="/interpretability" className="flex items-center gap-3 p-3 rounded-lg bg-slate-800/50 hover:bg-slate-800 transition-colors">
                    <span className="text-green-400">🔍</span>
                    <div className="flex-1">
                      <p className="text-sm text-slate-300">Feature Attribution</p>
                      <p className="text-xs text-slate-500">SHAP values, feature importance, dependence plots</p>
                    </div>
                  </Link>
                  <Link to="/analytics" className="flex items-center gap-3 p-3 rounded-lg bg-slate-800/50 hover:bg-slate-800 transition-colors">
                    <span className="text-green-400">📊</span>
                    <div className="flex-1">
                      <p className="text-sm text-slate-300">Population Analytics</p>
                      <p className="text-xs text-slate-500">Distributions, correlations, ACWR zones</p>
                    </div>
                  </Link>
                </div>
                ...
                <Link
                  to="/validation"
                  className="mt-4 w-full py-3 bg-green-600 hover:bg-green-500 text-white rounded-lg font-medium transition-colors flex items-center justify-center"
                >
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-900/20 via-slate-900 to-blue-900/20 border border-purple-500/20">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white">Run Your Own Experiments</h3>
                    <p className="text-xs text-slate-500">Create custom datasets and models</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                    <h4 className="text-sm font-semibold text-slate-300 mb-1">Generate New Cohorts</h4>
                    <p className="text-xs text-slate-500">Vary athlete count (100-5000), injury rates, simulation seed</p>
                  </div>
                  <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                    <h4 className="text-sm font-semibold text-slate-300 mb-1">Upload Your Data</h4>
                    <p className="text-xs text-slate-500">Import real Garmin/Strava exports for analysis</p>
                  </div>
                  <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                    <h4 className="text-sm font-semibold text-slate-300 mb-1">Train Different Models</h4>
                    <p className="text-xs text-slate-500">Compare Lasso, Random Forest, XGBoost with custom hyperparameters</p>
                  </div>
                  <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                    <h4 className="text-sm font-semibold text-slate-300 mb-1">What-If Analysis</h4>
                    <p className="text-xs text-slate-500">Simulate interventions on individual athletes</p>
                  </div>
                </div>

                <Link
                  to="/data-generation"
                  className="mt-4 w-full py-3 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-medium transition-colors flex items-center justify-center"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
                <div>
                  ...
                  <ul className="space-y-1 text-slate-500">
                    <li><Link to="/data-generation" className="hover:text-slate-300">→ Synthetic Cohort</Link></li>
                    <li><Link to="/ingestion" className="hover:text-slate-300">→ Real Data Upload</Link></li>
                    <li><Link to="/validation" className="hover:text-slate-300">→ Data Validation</Link></li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-purple-400 mb-2">Methods</h4>
                  <ul className="space-y-1 text-slate-500">
                    <li><Link to="/preprocessing" className="hover:text-slate-300">→ Feature Engineering</Link></li>
                    <li><Link to="/training" className="hover:text-slate-300">→ Model Development</Link></li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-green-400 mb-2">Results</h4>
                  <ul className="space-y-1 text-slate-500">
                    <li><Link to="/results" className="hover:text-slate-300">→ Model Performance</Link></li>
                    <li><Link to="/interpretability" className="hover:text-slate-300">→ Feature Attribution</Link></li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-amber-400 mb-2">Analysis</h4>
                  <ul className="space-y-1 text-slate-500">
                    <li><Link to="/analytics" className="hover:text-slate-300">→ Population Analytics</Link></li>
                    <li><Link to="/athletes" className="hover:text-slate-300">→ Individual Profiles</Link></li>
                  </ul>
                </div>
              </div>
            </Card>
              ...
              <div className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800">
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/validation" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-800/50 transition-colors group">
                    <div className="flex items-center gap-3">
                      <span className="text-base">🔬</span>
                      <span className="text-sm text-slate-300 group-hover:text-white">Data Validation</span>
                    </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-r from-green-500/5 to-emerald-500/5 border border-green-500/20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800">
                    <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">Model Type</p>
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-900/20 via-slate-900 to-blue-900/20 border border-purple-500/20">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-lg font-semibold text-white">Why Data Validation is Critical</h2>
              </div>

              <p className="text-sm text-slate-400 mb-4">
                Before training models on synthetic data, we must prove the data is <strong className="text-slate-300">scientifically valid</strong>.
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-sm font-semibold text-slate-300">Statistical Fidelity</h4>
                  </div>
                ...
                <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-sm font-semibold text-slate-300">Causal Fidelity</h4>
                  </div>
                  <p className="text-xs text-slate-500">
                ...
                <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-sm font-semibold text-slate-300">Transferability</h4>
                  </div>
                  <p className="text-xs text-slate-500">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/30 border border-slate-700/30">
                <p className="text-xs text-slate-500">
                  <strong className="text-slate-400">Workflow:</strong> Generate Cohort → <strong className="text-purple-400">Validate Data</strong> → Engineer Features → Train Models → Evaluate Results
                </p>
              ...
              <div className="space-y-4 text-sm text-slate-400">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                    ...
                    <p className="text-xs text-slate-500">Distributions are unrealistic—regenerate cohort with adjusted parameters</p>
                  </div>
                  <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                    <h4 className="font-semibold text-red-400 text-xs mb-1">Causal Failure</h4>
                    <p className="text-xs text-slate-500">ACWR-injury relationship is wrong—check injury simulation parameters</p>
                  </div>
                  <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                    <h4 className="font-semibold text-red-400 text-xs mb-1">Transfer Failure</h4>
                    <p className="text-xs text-slate-500">Models don't generalize—may indicate domain gap issues</p>
                  </div>
                </div>
              </div>
            </Card>
                ...
                {loading.datasets ? (
                  ...
                  <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-500">Pre-computed reference dataset</p>
                            </div>
                          </div>
                    ...
                    {datasets.filter(ds => ds.id !== 'dataset_reference').length > 0 ? (
                      <div>
                        <p className="text-xs text-slate-500 uppercase tracking-wider mb-2">Your Experiments</p>
                      ...
                      <div className="text-center py-6">
                        ...
                        <p className="text-slate-500 text-sm">No custom cohorts</p>
