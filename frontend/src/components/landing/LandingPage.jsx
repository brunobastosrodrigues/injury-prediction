    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="max-w-4xl mx-auto px-6 py-4 flex justify-between items-center">
          <span className="text-gray-600 text-sm">Research Platform</span>
          <nav className="flex items-center gap-6 text-sm">
            ...
            <Link to="/pipeline" className="text-blue-600 hover:text-blue-800 font-medium">
              Open Platform
            </Link>
          </nav>
        </div>
      ...
      {showCitation && (
        ...
        >
          <div className="max-w-lg w-full bg-white rounded-lg shadow-xl p-6" onClick={e => e.stopPropagation()}>
            <h3 id="citation-title" className="text-lg font-semibold text-gray-900 mb-4">Citation</h3>
            <CitationBlock />
            <button
              ref={closeButtonRef}
              onClick={closeCitationModal}
              className="mt-4 w-full py-2 text-sm text-gray-600 hover:text-gray-900 border border-gray-300 rounded"
            >
              Close
            </button>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Title */}
        <h1 className="text-3xl font-serif font-bold text-gray-900 text-center mb-8 leading-tight">
          Prospective Injury Risk Prediction in Triathletes:<br />
          <span className="font-normal">A Synthetic Data Approach Using Machine Learning</span>
        </h1>
        ...
        <section className="mb-12">
          <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-4">Abstract</h2>
          <div className="text-gray-700 leading-relaxed space-y-4 text-justify">
            <p>
              <strong>Background:</strong> Training-related injuries represent a critical challenge in endurance sports,
            ...
            <p>
              <strong>Methods:</strong> We present a computational framework addressing data scarcity through synthetic
            ...
            <p>
              <strong>Results:</strong> The framework enables reproducible model development with comprehensive evaluation
            ...
            <p>
              <strong>Conclusion:</strong> This platform demonstrates a methodology for synthetic data-driven research in
        ...
        {/* Keywords */}
        <section className="mb-12">
          <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-3">Keywords</h2>
        ...
        <section className="border-t border-gray-200 pt-8">
          <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-4">Access the Platform</h2>
